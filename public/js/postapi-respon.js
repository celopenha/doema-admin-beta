...
function postApiPosterior(data, page, pageAnterior, pagina) {
    var sessaoid = $('#sessao').val();
    $.post('/app/escola/list', data).done(function (response) {
        var tr = "";
        response.itens.forEach(function (data) {
            ...
            tr += '<tr>' +
                ...
                '<td>' +
                '<a href="/app/crianca-sessao/create/'+ sessaoid +'/'+ data.id +'" data-toggle="tooltip"' +
...
function postApi(json, page, pageAnterior, pagina) {
    var sessaoid = $('#sessao').val();
    $.post('/app/escola/list', json).done(function (response) {
        var tr = "";
